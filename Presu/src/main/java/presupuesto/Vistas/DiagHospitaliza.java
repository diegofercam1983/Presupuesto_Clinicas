...
public class DiagHospitaliza extends JDialog {
	...
	public DiagHospitaliza(final Frame parent, final boolean modal) {
		super(parent, modal);
		this.initComponents();
	...
	private void initComponents() {
		...
		this.jLabel1.setText("HOSPITALIZACIÓN");
		...
		this.jLabel3.setText("OCUPACIÓN PISO 6");
		this.jLabel4.setFont(new Font("Tahoma", 1, 11));
		this.jLabel4.setForeground(new Color(102, 102, 255));
		this.jLabel4.setText("OCUPACIÓN PISO 7");
	...
	public void llenarDatos() {
		...
		this.jTextField3.setText(cp.consultarOcupacion(12, 3) + "%");
		this.jTextField1.setText(cp.consultarOcupacion(13, 111) + "%");
		this.jTextField2.setText(cp.consultarOcupacion(14, 112) + "%");
	}
}