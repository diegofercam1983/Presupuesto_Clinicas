...
public class DiagUciadulto extends JDialog {
	...
	public DiagUciadulto(final Frame parent, final boolean modal) {
		super(parent, modal);
		this.initComponents();
	...
	private void initComponents() {
		...
		this.jLabel1.setText("OCUPACIÓN UCI ADULTO");
		...
		this.jLabel3.setText("UCI CUIDADO INTERMEDIO");
		...
		jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
				...
				.addGroup(jPanel1Layout.createSequentialGroup().addContainerGap().addGroup(jPanel1Layout
						...
						.addComponent(this.jLabel1, -2, 160, -2))));
		jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
				.addGroup(jPanel1Layout.createSequentialGroup().addGap(11, 11, 11)
						...
						.addComponent(this.jButton1, -1, 32, 32767).addContainerGap()));
	...
	public void llenarDatos() {
		...
		this.jTextField3.setText(cp.consultarOcupacion(7, 5) + "%");
		this.jTextField1.setText(cp.consultarOcupacion(8, 115) + "%");
	}
}